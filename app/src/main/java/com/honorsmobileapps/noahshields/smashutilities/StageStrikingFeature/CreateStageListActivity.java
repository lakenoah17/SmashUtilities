...
public class CreateStageListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout layout_MainMenu = (LinearLayout) findViewById(R.id.LinearLayout_CreateStageListRootLayout);
        ...
        //This is for when the screen rotates. Will check if there is a array of stages selected saved
        ...
        //Makes all of the stage info objects
        ...
        saveStageList = findViewById(R.id.Button_SaveStageList);
        saveStageList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final PopupWindow popupWindow = new PopupWindow(customView, (int)(dpWidth / 2), (int)(dpHeight / 2));
